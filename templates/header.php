...
$server = 'http://' . $_SERVER['SERVER_NAME'] . '/online-exam/';
			...
			<div class="navbar-collapse collapse justify-content-between">
				<ul class="navbar-nav" id="navbar">
					<li class="nav-item active">
						<a class="nav-link text-dark" href="<?php echo $server; ?>index.php"><i class="fa fa-laptop text-dark"></i> Online Exam</a>
					</li>
					...
					<?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
						...
						if ($_SESSION['type'] == 'examiner') { ?>
							<li class="nav-item">
								<a class="nav-link text-dark" href="<?php echo $server; ?>components/subject/view.php">Subjects</a>
							</li>
							<li class="nav-item">
								<a class="nav-link text-dark" href="<?php echo $server; ?>components/mcq/view.php">MCQs</a>
							</li>
							<li class="nav-item">
								<a class="nav-link text-dark" href="<?php echo $server; ?>components/exam-report/view.php">Reports</a>
							</li>
					<?php }
					} ?>
3
